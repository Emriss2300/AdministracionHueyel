...
// Consulta SQL para obtener los registros de integrantes, solo los activos
$sql = "SELECT * FROM integrantes WHERE Activo = 'Si'";
...
<div>
    ...
    <div class="buttons-container">
        ...
        <a href="agregar.php" class="btn">Agregar Nuevo Integrante</a>
        
        <!-- Botón para ver integrantes inactivos -->
        <a href="admin_integrantes_inactivos.php" class="btn">Inactivos</a>

        <!-- Botón para ir al inicio -->
        <a href="http://localhost/hueyel/index.php" class="btn">Inicio</a>
    </div>
